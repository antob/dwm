...
static const Rule rules[] = {
	 ...
	 */
	/* class        instance  title               tags mask  isfloating  isterminal  noswallow  isfullscr borderpx monitor */
	{ NULL,         NULL,     "Arcolinux Logout", 0,         0,          0,           0,         1,        0,      -1 },
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_u,      setlayout,      {.v = &layouts[5]} }, /* grid */
